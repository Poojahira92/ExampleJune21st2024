...
public class SingletonDesignPatternDemo {
    public static void main(String[] args) {
        ...
        if((o1==o2) && (o2==o3))
        {
            System.out.println("We have achieved Singleton Design Pattern");
        }
        else
        {
            System.out.println("We have not achieved Singleton Design Pattern");
        }
    }
}
